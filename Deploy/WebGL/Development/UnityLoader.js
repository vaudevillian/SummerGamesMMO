...
(function() {
 var loadPackage = function(metadata) {
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 3574421;
      var PACKAGE_UUID = '0ca5f283-fcc1-42c6-8ab8-110088225018';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 666723, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(666723, 666744, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(666744, 666767, 0, 0).open('GET', '/PlayerConnectionConfigFile');
    new DataRequest(666767, 666788, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(666788, 2050736, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(2050736, 3546796, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(3546796, 3574421, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
